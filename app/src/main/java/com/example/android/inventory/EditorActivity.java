...
public class EditorActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            // into one of the dropdown options (0 is Pearson, 1 is AK, 2 is Howarth Press).
            // Then call setSelection() so that option is displayed on screen as the current selection.
            switch (supplierName) {
                case BookEntry.SUPPLIER_NAME_AK:
                    mSupplierNameSpinner.setSelection(1);
                    break;
                case BookEntry.SUPPLIER_NAME_HOWARTH_PRESS:
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mSupplierNameSpinner.setSelection(0); // Select "Pearson" supplier name
    }
